...
test_cases = [
    {
        "name": "1. Thanks with strong history (Checking Acknowledgment)",
        "role": "HR",
        "question": "thanks",
        "history": [
...
with codecs.open("test_results_v2.txt", "w", encoding="utf-8") as f:
    f.write("🚀 Starting Personality & Intent Stress Test...\n")
    f.write("=" * 60 + "\n")
